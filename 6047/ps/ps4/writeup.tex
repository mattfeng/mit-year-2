...
\begin{tabular}{ c  c  c  c  c }
    \hline
    {\bf Model} & {\bf Hyperparameters} & {\bf Train Accuracy} & {\bf Test Accuracy} & {\bf Training Time}\\
    \hline
    (1) & % model no.
...
\begin{tabular}{ c  c  c  c  c }
    \hline
    {\bf Model} & {\bf Architecture} & {\bf AC (Train)} & {\bf AC (Test)} & {\bf Time}\\
    \hline
