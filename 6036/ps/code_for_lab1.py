...
def gen_flipped_lin_separable(num_points=20, pflip=0.1, th=np.array([[3],[4]]), th_0=np.array([[0]]), dim=2):
...
def eval_learning_alg(learner, data_gen, n_train, n_test, it):
    ...
    return sum(eval_classifier(learner, # evaluate the learning algo
                               data_train, labels_train, # generate a train set
                               data_train, labels_train) # generate a test set
...
print(eval_learning_alg(perceptron, gen_flipped_lin_separable, 20, 20, 1000))
print(eval_learning_alg(averaged_perceptron, gen_flipped_lin_separable, 20, 20, 1000))